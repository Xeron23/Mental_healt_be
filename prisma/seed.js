...
console.log('🌱 Starting database seed...');
  ...
  const user = await prisma.user.findFirst({
    ...
    data: [
      { userId: user.user_id, title: "Refleksi Pagi", content: "Hari ini saya merasa produktif dan fokus.", mood: "joy", createdAt: new Date("2025-10-18T08:00:00Z"), updatedAt: new Date("2025-10-18T08:00:00Z") },
      { userId: user.user_id, title: "Hari Berat", content: "Banyak tantangan hari ini, merasa sedih.", mood: "sad", createdAt: new Date("2025-10-18T09:30:00Z"), updatedAt: new Date("2025-10-17T09:30:00Z") },
      { userId: user.user_id, title: "Meditasi Malam", content: "Meditasi membuat hati lebih tenang.", mood: "joy", createdAt: new Date("2025-10-18T21:00:00Z"), updatedAt: new Date("2025-10-16T21:00:00Z") },
      { userId: user.user_id, title: "Meeting Panjang", content: "Rapat yang melelahkan, merasa marah.", mood: "anger", createdAt: new Date("2025-10-18T14:00:00Z"), updatedAt: new Date("2025-10-16T14:00:00Z") },
      { userId: user.user_id, title: "Belajar Node.js", content: "Mendalami Prisma dan Express hari ini.", mood: "joy", createdAt: new Date("2025-10-18T10:00:00Z"), updatedAt: new Date("2025-10-15T10:00:00Z") },
      { userId: user.user_id, title: "Coding Challenge", content: "Selesaikan beberapa soal algoritma.", mood: "joy", createdAt: new Date("2025-10-18T15:00:00Z"), updatedAt: new Date("2025-10-14T15:00:00Z") },
      { userId: user.user_id, title: "Olahraga Pagi", content: "Push-up dan sit-up pagi hari.", mood: "joy", createdAt: new Date("2025-10-18T06:30:00Z"), updatedAt: new Date("2025-10-13T06:30:00Z") },
      { userId: user.user_id, title: "Belajar React", content: "Membuat komponen baru dan latihan props.", mood: "joy", createdAt: new Date("2025-10-18T09:00:00Z"), updatedAt: new Date("2025-10-12T09:00:00Z") },
      { userId: user.user_id, title: "Hari Cemas", content: "Sedikit takut menghadapi deadline.", mood: "fear", createdAt: new Date("2025-10-18T12:00:00Z"), updatedAt: new Date("2025-10-12T12:00:00Z") },
      { userId: user.user_id, title: "Berjalan Santai", content: "Jalan santai di taman sore hari.", mood: "joy", createdAt: new Date("2025-10-18T18:00:00Z"), updatedAt: new Date("2025-10-11T18:00:00Z") },
      { userId: user.user_id, title: "Menulis Diary", content: "Menulis pengalaman hari ini.", mood: "sad", createdAt: new Date("2025-10-18T21:00:00Z"), updatedAt: new Date("2025-10-11T21:00:00Z") },
      { userId: user.user_id, title: "Meditasi Siang", content: "Meditasi singkat membuat rileks.", mood: "joy", createdAt: new Date("2025-10-18T13:00:00Z"), updatedAt: new Date("2025-10-10T13:00:00Z") },
      { userId: user.user_id, title: "Hari Marah", content: "Frustrasi karena komputer error.", mood: "anger", createdAt: new Date("2025-10-18T15:30:00Z"), updatedAt: new Date("2025-10-10T15:30:00Z") },
      { userId: user.user_id, title: "Belajar Prisma", content: "Mencoba query lanjutan di Prisma.", mood: "joy", createdAt: new Date("2025-10-09T10:00:00Z"), updatedAt: new Date("2025-10-09T10:00:00Z") },    ],
    skipDuplicates: true
  });
  ...
  console.log("Seeder FaceDetection berhasil dijalankan!");
